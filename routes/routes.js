...
app.get('/classes/:classID/notebook/:notesID/comments', notesController.getNotesComments);
...
app.get('/classes/:classID/discussions/:discID/comments', discController.getDiscussionComments);
